...
export function createBoundary(Component, params = {}) {
  if (Component.$$render) {
    ...
    Component.$$render = (result, props, bindings, slots) => {
      ...
      try {
        return render(result, { error, ...props, ...params }, bindings, slots);
      } catch (e) {
        error.set(e);
        return render(result, { error, ...props, ...params }, bindings, {});
      }
    };
